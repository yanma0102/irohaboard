...
<head>
	...
	<?php
		...
		$is_admin_page = $this->AppView->isAdminPage() && !$this->AppView->isLoginPage();
...
<body>
	...
	<footer class="footer ib-theme-color text-center">
		<?= h($this->AppView->readSession('Setting.copyright')); ?>
	</footer>
	
	<?php if(isset($loginedUser) && $this->AppView->isAdminPage()) {?>
	<div class="irohasoft">
